...
const (
	...
	//   {{if .C}}<a href="{{end}}{{.X}}
	// Discussion:
	//   Package gf/html/template statically examines each path through an
	...
	// Discussion:
	//   Package gf/html/template looks through template calls to compute the
	//   context.
	...
	// Discussion:
	//   Package gf/html/template does not support interpolation into regular
	...
	// Discussion:
	//   Package gf/html/template does not support actions following a
	//   backslash.
